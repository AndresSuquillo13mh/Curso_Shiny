...
Ubique las líneas de código relevantes en app.R la construcción del widget selector para el eje Y. Esto está en una función **selectInput()** que comienza en la línea 20, debajo del comentario **# Select variable for y-axis**. Tenga en cuenta que esta función toma cuatro argumentos: **inputId, label, choices, y selected**. Cambie el selectedargumento a **imdb_rating**, guarde los cambios y vuelva a ejecutar la aplicación haciendo clic en Ejecutar aplicación.
...
Sin embargo, antes revisemos la estructura visual básica de la App Shiny.
